...
export PIPELINE_SCRIPT_DIR="${PIPELINE_SCRIPT_DIR:-$(cd "$(dirname "${BASH_SOURCE[0]:-$0}")/../../../modules/module-02-bulk-rnaseq/scripts" && pwd)}"
...
# or leftover BAMs.
WORKDIR="/scratch/$(whoami)/master_rnaseq_pipeline_${REFERENCE_TYPE}_${GENOME_TAG}_${RUN_TAG}"
